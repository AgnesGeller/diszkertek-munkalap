...
const instrumented = source.replace('})();', 'globalThis.__test = { setDraft: value => { draft = value; }, renderReferrers, worksheetReferrerEntries };})();');
...
const { setDraft, renderReferrers, worksheetReferrerEntries } = context.__test;
