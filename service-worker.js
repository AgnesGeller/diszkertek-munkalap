const CACHE="diszkertek-onallo-munkalap-v2";
const ASSETS=["./","./index.html","./styles.css","./app.js?v=2","./manifest.webmanifest","./icon.svg","./logo.svg","./botanical.svg","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
