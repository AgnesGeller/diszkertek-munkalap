const CACHE="diszkertek-onallo-munkalap-v4";
const ASSETS=["./","./index.html","./styles.css","./logo-overrides.css","./app.js?v=4","./manifest.webmanifest","./official-logo.png","./official-emblem.png","./botanical.svg","./official-icon-192.png","./official-icon-512.png","./apple-touch-icon-official.png"];
