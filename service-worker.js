...
const ASSETS=["./","./index.html","./styles.css","./logo-overrides.css","./app.js?v=2","./manifest.webmanifest","./official-logo.png","./official-emblem.png","./botanical.svg","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
